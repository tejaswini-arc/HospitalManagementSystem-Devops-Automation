...
public class DepartmentController {
    ...
    public ResponseEntity<DepartmentResponseDto> assignDoctors(@PathVariable Long departmentId,
                                                               @RequestBody Set<Long> doctorIds) {
        return ResponseEntity.ok(departmentService.assignDoctors(departmentId, doctorIds));
    }
}
